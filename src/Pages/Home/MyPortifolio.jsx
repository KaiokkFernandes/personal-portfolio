...
import data from "../../Data/index.json"; // Certifique-se de que o caminho está correto
  ...
  return (
    <section className="portfolio--section" id="MyPortfolio">
      <div className="portfolio--container-box">
        ...
        <div>
          <button className="btn btn-github" onClick={() => window.open("https://github.com/KaiokkFernandes", '_blank')}>
            <svg
